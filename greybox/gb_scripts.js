...
function update_comments(cid){

	var tc = document.getElementById("t_comments_"+cid).innerHTML;
	var tc = parseInt(tc)+1;
	document.getElementById("t_comments_"+cid).innerHTML = tc;
}
...
/*
	...
	var doc = hereName.split("?");
	var docName = doc[0];
		
	if(docName == "profile.php"){
		window.location.reload();
	}else if(docName == "articles.php"){
		window.location.reload();
	}else if(docName == "articles_list.php"){
		window.location.reload();
	}else if(docName == "article.php"){
		window.location.reload();
	}
*/
},onShow:function(){
